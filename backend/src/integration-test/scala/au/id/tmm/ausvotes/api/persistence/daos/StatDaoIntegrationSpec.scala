...
import au.id.tmm.ausvotes.api.persistence.daos.StatDaoIntegrationSpec._
...
import au.id.tmm.ausvotes.core.model.parsing.{Division, JurisdictionLevel, VoteCollectionPoint}
