package au.id.tmm.ausvotes.backend.services

import javax.inject.Inject

import au.id.tmm.ausvotes.backend.persistence.daos.ElectionDao.withParsedElection
import au.id.tmm.ausvotes.backend.persistence.daos.{DivisionDao, StatDao}
import au.id.tmm.ausvotes.backend.persistence.entities.stats.Stat
import au.id.tmm.ausvotes.backend.services.exceptions.{NoSuchDivisionException, NoSuchStateException}
