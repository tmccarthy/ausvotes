...
import au.id.tmm.ausvotes.core.reportwriting.table.Column.{DenominatorCountColumn, FractionColumn, PrimaryCountColumn}
import au.id.tmm.ausvotes.core.reportwriting.table.Row.{DataRow, TotalsRow}
import au.id.tmm.ausvotes.core.tallies.Tally1
