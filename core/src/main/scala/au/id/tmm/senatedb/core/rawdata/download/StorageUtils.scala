...
import au.id.tmm.senatedb.core.rawdata.download.DownloadUtils.{downloadUrlToFile, localResourceIntegrityCheck}
import au.id.tmm.senatedb.core.rawdata.resources.{Resource, ResourceWithDigest}
