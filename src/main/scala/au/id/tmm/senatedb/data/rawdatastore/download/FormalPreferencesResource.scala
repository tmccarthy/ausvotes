...
import au.id.tmm.senatedb.model.SenateElection._
import au.id.tmm.senatedb.model.State._
import au.id.tmm.senatedb.model.{SenateElection, State}
import au.id.tmm.utilities.hashing.Digest

private [download] final case class FormalPreferencesResource private(election: SenateElection, state: State,
                                                                      digest: Digest) {
...
private[download] object FormalPreferencesResource {
