...
import au.id.tmm.senatedb.reportwriting.table.Column.{DenominatorCountColumn, FractionColumn, PrimaryCountColumn}
import au.id.tmm.senatedb.reportwriting.table.Row.{DataRow, TotalsRow}
